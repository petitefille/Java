...
class Applikasjon {
	...
	Applikasjon() {
		...
		System.out.println(" [10] Hent legemiddel paa personnummer\n");
...
=========================================
 ...
 [5] Skriv ut alle legemidler
 [6] Skriv ut alle leger
 [7] Skriv ut avtaleleger
 [8] Skriv ut alle personer
 [9] Skriv ut person
 [10] Hent legemiddel paa personnummer

 [0] Avslutt

 > Velg onsket funksjon (0-10): 2
 > Navn: Hasse Lasse Hoff

 > Spesialist (1 = ja/0 = nei) (0-1): 1

 > Avtalenummer (0 = ingen avtale) (0-999999): 13

 > Velg onsket funksjon (0-10): 6

 Leger:
------------------------------
 - Hasse Lasse Hoff (spesialist) (avtalenr.: 13)
 - Jens
 - Lars lege (spesialist) (avtalenr.: 13)
 - Katrine-Line Persson (avtalenr.: 110)
 - Tore Trompet (spesialist) (avtalenr.: 13)
 - ?lf-?gir Bl?mann (spesialist)

 > Velg onsket funksjon (0-10): 3
 > Navn: ^C[emilyd@vor 777]$ java Oblig4
=========================================
 Leger og resepter
=========================================
 ...
 > Velg onsket funksjon (0-10): 5

 Legemidler:
--------------------------
 - 2: Zalo (pris: 75kr, mengde: 100.0)
 - 0: Paralgin Forte (pris: 150kr, mengde: 8.0)
 - 1: Placebo (pris: 50kr, mengde: 10.0)
...
------------------------------
 ...
 > Velg onsket funksjon (0-10): 7

 Avtaleleger:
------------------------------
 - Lars lege (Narkotiske resepter: 0)
 - Katrine-Line Persson (Narkotiske resepter: 0)
 - Tore Trompet (Narkotiske resepter: 1)

 > Velg onsket funksjon (0-10): 8

 Personer:
---------------------------
 - 0: Trude Lutt (k) (antall gyldige vanedannende resepter: 0)
 - 1: Finn Lutt (m) (antall gyldige vanedannende resepter: 0)
 - 2: K?re Kanin (m) (antall gyldige vanedannende resepter: 1)
 - 3: Bj?rg Bj?rnson (k) (antall gyldige vanedannende resepter: 0)
 - 4: Hasse Lasse Hoff (m) (antall gyldige vanedannende resepter: 0)
 - 5: Enpersonmedetveldiglangtnavnsomtilogmedinneholderdenorskebokstavene??? (k) (antall gyldige vanedannende resepter: 0)

 Totalt antall gyldige vanedannende resepter: 1
  - Kvinner: 0
  - Menn: 1

 > Velg onsket funksjon (0-10): 9

 > Personnummer (0-999999): 0
 - Navn: Trude Lutt (k)
 - P.nr.: 0
 - Blaa resepter:

 > Velg onsket funksjon (0-10): 10

 > Personnummer (0-999999): 4

 > Reseptnummer (0-999999): 2

 > Velg onsket funksjon (0-10): 10

 > Personnummer (0-999999): 3

 > Reseptnummer (0-999999): 0

 > Velg onsket funksjon (0-10): 4
 > Resepttype (h = hvit, b = blaa): b

 > Personnummer (0-9999): 2
 > Lege (navn): Tore Trompet

 > Legemiddelnummer (1-9999): 1

 > Reit (1-99): 3

 > Velg onsket funksjon (0-10): 3
 > Navn: Victoria Dupont
 > Kjonn (k/m): k
 ...
 Personer:
---------------------------
 - 6: Victoria Dupont (k) (antall gyldige vanedannende resepter: 0)
 - 1: Finn Lutt (m) (antall gyldige vanedannende resepter: 0)
 - 2: K?re Kanin (m) (antall gyldige vanedannende resepter: 1)
 - 3: Bj?rg Bj?rnson (k) (antall gyldige vanedannende resepter: 0)
 - 4: Hasse Lasse Hoff (m) (antall gyldige vanedannende resepter: 0)
