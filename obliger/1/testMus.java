...
// Denne metoden måtte jeg lage fordi hvis katten hadde 2 eller fler mus i magen, så vil den bite musen som lever (men ikke spise den).
// Dette medfører at hvis musen er frisk, så blir den syk, og hvis musen er syk, så dør den.
// Derfor har jeg da gjort det slik at metoden gaaPaaJaktI kaller på metoden bitt() når katten
// som går på jakt har 2 eller fler mus i magen, slik at musen som bor i musebolet vil da bli syk eller dø.
    public void bitt()
    {
        if (!syk) 
        {
