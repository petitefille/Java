class Oblig01emilyd {// bytt ut "bnavn" med brukernavnet ditt
	...
	// nÃÂ¥r bolet ikke er bebodd av ei mus.
	if ( musebolet.tomt() ) {
	 ...
	 * 2 katter og 3 mus. For mus og katt trenger du bare ÃÂ¥ ha med alle detaljer
	 * i ett av objektene
	 *
	 */
	...
	// La jakta starte!
	// FÃÂ¸rst er det Pus som fÃÂ¥r 2 forsÃÂ¸k
	...
	for (int i=0; i < 2; i++) {
	    ...
	    System.out.println("============= Tester Pus (i lÃÂ¸kke) :");
	...
	// SÃÂ¥ tester vi at Pus nÃÂ¥ er mett, og at musa er blitt syk etter
	// ÃÂ¥ ha blitt bitt...
	...
	// Deretter fÃÂ¥r Mons og Pus 2 forsÃÂ¸k hver annenhver gang:
	...
	//  Vi lar sÃÂ¥ en ny katt, Jery spise ei syk mus:
	...
	// SÃÂ¥ lar vi en mett katt skade musa til den dÃÂ¸r:
	...
	// sjekker til slutt at Jerry ikke spiser den dÃÂ¸de musa i bolet
...
Terminal> java Oblig01emilyd
============= Tester Pus:
== Tester kattens navn: Pus, OK.
== Tester kattens vekt: 4560, OK.
== Tester antall mus i magen: 0, OK.
== Tester om katten er syk: false, OK.
============= Tester Mons:
== Tester kattens navn: Mons, OK.
== Tester kattens vekt: 5000, OK.
== Tester antall mus i magen: 0, OK.
== Tester om katten er syk: false, OK.
********* Test av musobjekt, testid: A ***
** navn: musNr1, OK.
** syk: false, OK.
** vekt: 37, OK.
** lever: true, OK.
********* Test av musobjekt, testid: B ***
** navn: musNr2, OK.
** syk: true, OK.
** vekt: 38, OK.
** lever: true, OK.
 ###### P Musebolet er tomt
 ###### Q Musebolet er bebodd:
---  IBOL  --- Info om mus: navn:musNr3, vekt:39, syk:false, lever:true
 ###### R Musebolet er tomt
--- B1 --- Info om mus: navn:musNr3, vekt:39, syk:false, lever:true
============= Tester Pus (i lÃÂ¸kke) :
== Tester antall mus i magen: 1, OK.
== Tester kattens vekt: 4599, OK.
== Tester om katten er syk: false, OK.
--- B1 --- Info om mus: navn:musNr4, vekt:55, syk:false, lever:true
============= Tester Pus (i lÃÂ¸kke) :
== Tester antall mus i magen: 2, OK.
== Tester kattens vekt: 4654, OK.
== Tester om katten er syk: false, OK.
********* Test av musobjekt, testid: X ***
** navn: musNr5, OK.
** syk: false, OK.
** vekt: 56, OK.
** lever: true, OK.
********* Test av musobjekt, testid: Y ***
** navn: musNr5, OK.
** syk: true, OK.
** vekt: 56, OK.
** lever: true, OK.
--- B2 --- Info om mus: navn:musNr5, vekt:56, syk:true, lever:true
--- B3 --- Info om mus: navn:musNr6, vekt:44, syk:false, lever:true
--- B2 --- Info om mus: navn:musNr6, vekt:44, syk:true, lever:true
--- B3 --- Info om mus: navn:musNr7, vekt:45, syk:false, lever:true
********* Test av musobjekt, testid: Z ***
** navn: musNr7, OK.
** syk: true, OK.
** vekt: 45, OK.
** lever: true, OK.
--- B4 --- Info om mus: navn:musNr8, vekt:77, syk:false, lever:false
== Tester Jerrys antall mus i magen: 1, OK.
== Tester Jerrys antall mus i magen: 1, OK.
============= Tester Pus:
== Tester kattens navn: Pus, OK.
== Tester kattens vekt: 4654, OK.
...
============= Tester Mons:
== Tester kattens navn: Mons, OK.
== Tester kattens vekt: 5100, OK.
== Tester antall mus i magen: 2, OK.
== Tester om katten er syk: true, OK.
============= Tester Jerry:
== Tester kattens navn: Jerry, OK.
== Tester kattens vekt: 5045, OK.
== Tester antall mus i magen: 1, OK.
== Tester om katten er syk: true, OK.
