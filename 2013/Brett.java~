...
class Brett {
	...
	public void finnLosninger() {
		...
		System.out.println("[*] Leter etter loesninger...");
		...
		long stopTime = System.currentTimeMillis();
      	...
      	if (this.hentBeholder().hentAntallLosninger() > 0)
			System.out.println("[*] Fant totalt " + this.hentBeholder().hentAntallLosninger() + " loesning(er) (brukte " + elapsedTime + " ms.)");
		else
			System.out.println("[*] Fant ingen loesninger (brukte " + elapsedTime + " ms.)");
	}
