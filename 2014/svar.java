...
abstract class Frukt {
    ...
    @Override public boolean equals(Object o) {
	return false;
	// fordi objektet ikke bare kan vÃ¦re frukt
    }
}
...
class Beholder {
    ...
    private Node f; // peker til fÃ¸rste node
	...
	Node fjernSist() {
		...
		ret = this;
	    else ; // tom node, ret skal vÃ¦re null
    ...
    void fjern (Object o) {
	// lista mÃ¥ ikke vÃ¦re tom:
	if ( ant > 0) {
	    // spesialtilfelle, fÃ¸rste element skal fjernes:
	    if ( f.obj.equals(o) ) {
		f = f.neste;
		ant--;
	    }
		...
		for (int i = 1; i<=ant; i++)
			...
			// nn.neste er nÃ¥ noden som skal fjernes
			nn.neste = n.neste;
			ant--;
			break;
		    }
